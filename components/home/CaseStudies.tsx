              ...
              >
                ...
                >
                  <Image
                    ...
                    alt="Urban Fitness - Cadena de Gimnasios"
                    fill
                  ...
                  <div className="absolute inset-0 flex items-end justify-center p-8">
                    <div className="text-center text-white">
                      <h4 className="font-monda text-3xl font-bold mb-2">Urban Fitness</h4>
                      <p className="text-gray-200 text-lg">Cadena de gimnasios líder</p>
                    </div>
                  </div>
                </motion.div>
              </motion.div>
