            ...
            <div className="p-8 lg:p-12">
              ...
              <div className="grid grid-cols-2 gap-4 mb-8">
                <motion.button
                  ...
                  className="flex flex-col items-center justify-center p-6 rounded-xl border-2 border-gray-300 hover:border-black transition-all duration-300"
                >
              ...
              {activeTab === 'chat' && <AIBookingChat />}
              
              {/* Paso a paso visual cuando no hay chat activo */}
              {activeTab === 'form' && (
                <div className="text-center py-12 space-y-4">
                  ...
                  <h3 className="font-bold text-xl text-black">📅 Selecciona el día y hora que mejor te convenga en nuestro calendario.</h3>
                  <p className="text-gray-600">Haz clic en el botón "Agenda una demo" para ver nuestras disponibilidades.</p>
                </div>
              )}
